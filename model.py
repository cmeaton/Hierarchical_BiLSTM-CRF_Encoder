...
from process_data import load_process_data, custom_tokenize


### the directory where you saved the files
directory = 'your_directory_here/'
### loaded and processed text data, labels (X,y)
text_list, label_list = load_process_data(directory)
### tokenization of text data
sequences = custom_tokenize(text_list)
